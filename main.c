...
int main ()
{
    char Reponse [50][10] =
    {
        "was", "became", "began", "brought", "bought",
        "chose", "came", "did", "drank", "drove",
        "ate", "fell", "felt", "found", "flew", "forgot",
        "got", "gave", "went", "had", "heard", "kept", "knew",
        "left", "lent", "let", "lost", "made", "met",
        "paid", "put", "read", "ran", "said", "saw", "sold",
        "sent", "sang", "sat", "slept", "spoke", "stood",
        "swam", "took", "taught", "told", "thought", "understood",
        "wore", "wrote"
    };
    ...
    printf("Simulateur de Verbe irregulier");
